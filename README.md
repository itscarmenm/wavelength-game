...
Un divertido juego de mesa digital basado en el concepto de **Wavelength**, donde los jugadores deben sintonizar su "longitud de onda" para adivinar posiciones en un dial basadas en pistas de conceptos opuestos.
...
## 🛠️ Instalación local
Si quieres probar el código o hacer cambios en tu ordenador:
1. Clona el repositorio o descarga los archivos.
2. Abre el archivo `index.html` en tu navegador.

---
Creado con ❤️ por [itscarmenm](https://github.com/itscarmenm)
